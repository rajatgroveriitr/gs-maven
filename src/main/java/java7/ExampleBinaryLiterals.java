...
//In Java 7, Binary Literal allows to express integral types (byte, short, int, and long) in binary number system.
// To specify a binary literal, add the prefix 0b or 0B to the integral value.
public class ExampleBinaryLiterals {
    public static void main(String[] args) {
//        binaryLiterals();

        negativeBinaryLiteral();
    }
    ...
    private static void binaryLiterals() {
        ...
        long l1 = 0b0000011111100100;   // Using b0, The b can be lower or upper case
        long l2 = 0B0000011111100100;   // Using B0
        System.out.println("----------Binary Literal in Long----------------");
        System.out.println("l1 = "+l1);
        System.out.println("l2 = "+l2);
    }

    private static void negativeBinaryLiteral() {
